...
class _BigButtonState extends State<BigButton> {
  ...
  Widget build(BuildContext context) {
    ...
    final fg =
        widget.textColor ?? (widget.outline ? widget.color : Colors.white);
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: widget.outline
                ? Colors.transparent
                : (on ? widget.color : Boli.sand),
            border: Border.all(
              color: on ? widget.color : Boli.sand,
              width: 2.5,
            ),
        ...
        child: GestureDetector(
          ...
          child: Container(
            decoration: Boli.card(
              border: urgent ? Boli.terracotta.withValues(alpha: .5) : null,
            ),
            child: Column(
              children: [
                Padding(
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border(
                      top: BorderSide(color: Boli.sand, width: 1.5),
                    ),
                  ),
                  child: Row(
                    children: [
              ...
              children: [
                ...
                Text(
                  ...
                  style: Boli.body(
                    ...
                    color: on ? Boli.cream : Boli.inkSoft,
                  ),
                ),
              ],
            ),
        ...
        child: Stack(
          ...
          children: [
                  ...
                  builder: (_) {
                    ...
                    return Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                          color: Boli.terracotta.withValues(
                            alpha: (1 - v) * .55,
                          ),
                          width: 3,
                        ),
            ...
            Container(
              ...
              child: Icon(
                widget.busy ? Icons.graphic_eq_rounded : Icons.mic_rounded,
                color: Colors.white,
                size: widget.size * .44,
              ),
            ),
