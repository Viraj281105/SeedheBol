  ...
  _RoleplayPersona(
    ...
    questions: [
      ...
      _RoleplayQuestion(
        ...
        moodEmoji: '👔',
        topic: 'VIP inspection walkthrough',
      ),
      _RoleplayQuestion(
        ...
        moodEmoji: '🌧️',
        topic: 'Monsoon protection and covering',
      ),
      _RoleplayQuestion(
        ...
        moodEmoji: '🌟',
        topic: 'Quality work appreciation',
      ),
      _RoleplayQuestion(
        ...
        moodEmoji: '🚀',
        topic: 'Early shift wrap-up incentive',
      ),
    ],
  ),
  _RoleplayPersona(
    ...
    questions: [
      ...
      _RoleplayQuestion(
        ...
        mood: 'नवीन उत्पादन (Product Pitch)',
        moodEmoji: '✨',
        topic: 'Waterproofing material pitch',
      ),
      _RoleplayQuestion(
        ...
        moodEmoji: '🔄',
        topic: 'Unused tiles return guarantee',
      ),
    ],
  ),
  _RoleplayPersona(
    ...
    questions: [
      ...
      _RoleplayQuestion(
        ...
        moodEmoji: '🎒',
        topic: 'Toolbag inspection at gate',
      ),
      _RoleplayQuestion(
  ...
  _RoleplayPersona(
    ...
    questions: [
      ...
      _RoleplayQuestion(
        ...
        moodEmoji: '⚙️',
        topic: 'Machine oiling & maintenance',
      ),
      _RoleplayQuestion(
  ...
  _RoleplayPersona(
    ...
    questions: [
      ...
      _RoleplayQuestion(
        ...
        moodEmoji: '🫖',
        topic: 'Ginger cardamom special tea',
      ),
      _RoleplayQuestion(
  ...
  _RoleplayPersona(
    ...
    questions: [
      _RoleplayQuestion(
        ...
        moodEmoji: '🏠',
        topic: 'Flooring progress timeline',
      ),
      _RoleplayQuestion(
        ...
        mood: 'सफाईदार काम (Quality Work)',
        moodEmoji: '🚿',
        topic: 'Plumbing leak prevention',
      ),
      _RoleplayQuestion(
  ...
  _RoleplayPersona(
    ...
    questions: [
      ...
      _RoleplayQuestion(
        ...
        moodEmoji: '💵',
        topic: 'Freight fare and helpers',
      ),
      _RoleplayQuestion(
        ...
        moodEmoji: '✍️',
        topic: 'Delivery challan sign-off',
      ),
    ],
  ),
];
