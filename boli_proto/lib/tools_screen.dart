...
class ToolsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final tools = [
      _T('Point the camera', 'कॅमेरा', 'Read a signboard, wage slip or prescription',
          Icons.photo_camera_rounded, Boli.terracotta),
      _T('Listen around me', 'आजूबाजूचे शब्द', 'Collect words spoken near you into tomorrow\'s practice',
          Icons.hearing_rounded, Boli.peacock),
      _T('Practise a conversation', 'संवाद', 'Talk to a supervisor, shopkeeper or clerk',
          Icons.forum_rounded, Boli.indigo),
      _T('Commute mode', 'प्रवासात', 'Hands free, screen off, audio only',
          Icons.directions_bus_rounded, Boli.madder),
      _T('Practise with someone', 'सोबत सराव', 'Tap two phones together, no internet',
          Icons.contactless_rounded, Boli.marigold),
      _T('Write the letters', 'अक्षरे', 'Trace Devanagari with your finger',
          Icons.draw_rounded, Boli.leaf),
    ];
    ...
    return SafeArea(
      ...
      child: ListView(
        ...
        children: [
          ...
          Text('Things this phone can do that a website cannot.',
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(tool.native, style: Boli.body(14.5, color: Boli.inkSoft)),
                  ],
                ),
              ),
              const Icon(Icons.chevron_right_rounded, color: Boli.inkSoft, size: 26),
            ]),
          ),
        ),
      );
          ...
          children: [
            Center(
              child: Container(
                  ...
                  height: 5,
                  decoration:
                      BoxDecoration(color: Boli.sand, borderRadius: BorderRadius.circular(4))),
            ),
            const SizedBox(height: 20),
            Row(children: [
              Container(
            ...
            Container(
              ...
              child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                const Icon(Icons.construction_rounded, size: 18, color: Boli.inkSoft),
        ...
        child: Column(
          ...
          children: [
            Row(children: [
              ...
              Text('WHAT LEAVES THIS PHONE', style: Boli.label(color: Boli.marigold, size: 11.5)),
            ]),
            const SizedBox(height: 10),
            Text('Nothing.',
                style: Boli.head(28, weight: 700, color: Boli.cream)),
            ...
            Text(
                ...
                style: Boli.body(14.5, color: Boli.cream.withValues(alpha: .78), height: 1.5)),
          ],
        ),
      );
}
